...
async function POST(request) {
    try {
        ...
        const generatedSlug = title.toLowerCase().replace(/[^a-z0-9]+/g, '-') // Replaces spaces with hyphens
        .replace(/(^-|-$)+/g, ''); // Removes extra hyphens at the ends
        const newPost = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].post.create({
            data: {
                title: title,
                content: content,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__867aa637._.js.map